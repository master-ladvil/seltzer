...
class RetailerBottombar extends StatefulWidget {
  const RetailerBottombar({Key? key}) : super(key: key);

  @override
  _RetailerBottombarState createState() => _RetailerBottombarState();
}

class _RetailerBottombarState extends State<RetailerBottombar> {
